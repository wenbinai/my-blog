...
public class EmailSender {
    ...
    private EmailSender() {
        EmailSender.config(EmailSender.SMTP_163(false), "aiwenbin_blog@163.com", "BDKYXJJJXOQNOLQU");
    }
     ...
     */
    public static void sendEmailVerifyCode(String emailAddress, String verifyCode) throws MessagingException {
        EmailSender.subject(Constants.Settings.EMAIL_TITLE)
                .from("博客系统官方")
                .text("邮箱验证码: " + verifyCode)
                .to(emailAddress)
                .send();
    }
}
